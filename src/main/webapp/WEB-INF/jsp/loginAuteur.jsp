...
<div class="login-box">
  <div class="login-logo">
    <a href="${pageContext.request.contextPath}/resources/theme/index2.html"><b>Headlines</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to create a new headlines</p>

      <form action="${pageContext.request.contextPath}/loginAuteur" method="post">
